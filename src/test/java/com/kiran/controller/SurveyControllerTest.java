...
public class SurveyControllerTest {
	...
	@Test
	public void retrieveDetailsForQuestino() throws Exception {
		Question mockQuestion = new Question("Question1", "Who is CEO of OCEANX?", "George",
				Arrays.asList("Kiran", "George", "Barry", "Peter"));
