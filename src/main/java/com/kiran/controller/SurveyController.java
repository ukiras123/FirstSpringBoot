...
public class SurveyController {
	...
	public List<Question> retrieveQuestionsForSurver(@PathVariable String surveyId)
	{
		return surveyService.retrieveQuestions(surveyId);
	}
	
	@GetMapping("/surveys/{surveyId}/questions/{questionId}")
	public Question retrieveDetailsForQuestino(@PathVariable String surveyId, @PathVariable String questionId)
	{
